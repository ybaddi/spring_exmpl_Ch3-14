...
//		iArticleDataA.setName("Iam Article A");
		...
		System.out.println(iArticleDataA.getUserDao().getFirstName());
		
		Map<String, String> mapProperty = iArticleDataA.getMapProperty();
		for (Map.Entry<String, String> pair : mapProperty.entrySet()) {
